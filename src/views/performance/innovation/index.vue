        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleDelete"
              v-hasPermi="['pm:innovation:remove']"
              >删除</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              :disabled="multiple"
              @click="handleExamine"
              v-hasPermi="['pm:innovation:examine']"
              >审核通过</el-button
            >
          </el-col>
          <el-col :span="1.5">
          ...
          <el-col :span="1.5">
            <el-button
              ...
              icon="Upload"
              @click="handleImport"
              v-hasPermi="['pm:innovation:import']"
              >导入</el-button
            >
          </el-col>
          <el-col :span="1.5">
            <el-button
              ...
              icon="Download"
              @click="handleExport"
              v-hasPermi="['pm:innovation:export']"
              >导出</el-button
            >
          </el-col>
          <right-toolbar
...
function handleImport() {
  upload.title = "本科生参加创新活动、技能竞赛获奖情况统计导入";
...
function handleAdd() {
  reset();
  open.value = true;
  title.value = "添加本科生参加创新活动、技能竞赛获奖情况";
...
function handleUpdate(row) {
  ...
  getCompetition(id).then((response) => {
    ...
    open.value = true;
    title.value = "修改本科生参加创新活动、技能竞赛获奖情况";
  });
}
/** 审核通过按钮操作 */
